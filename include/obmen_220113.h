//#define ASTRA 1	//= компиляции с "-D ASTRA=1" // без ASTR'ы - закомментировать 
//#undef  ASTRA		//= компиляции с "-U ASTRA"
/*
...
// !!!! ни Симфонии ни Чардаша !!!!!
	...
	short			pr_AS;			// !!!!!  признак приема сигнала на последнем такте
...
typedef struct	{
	...
	short			pr_rejim_AS;//признак автосопровождения 1-есть/0-нет
//добавлено 06/06/2018 по СЗ:
	short			status_test;//результат выполнения команд 11,12,13,14,15
	unsigned short	count_test;	//счётчик команд
